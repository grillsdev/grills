...
const Hero = () => {
  ...
  <div className="space-y-4">
    ...
    <p className="max-w-2xl text-foreground/80 md:text-[2vw] lg:text-xl font-medium z-50">
      Your own <span className="font-bold">AI </span> platform. <span className="text-pink-400 ">Open Source</span> alternative for <span className="font-bold text-white">Lovable Bolt & V0.</span> Just generate, copy & paste into your production codebase. No overhead works with your favorite llm <span className="text-base font-semibold tracking-tight">(BYOK)</span>
    </p>
  </div>
  );
};
